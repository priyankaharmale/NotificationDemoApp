 ...
 */
public class LostFoundPetDetails extends AppCompatActivity {
    lostFoundPetListModel petObject;
    ...
    public void onCreate(Bundle savedInstaceState) {
        ...
        setContentView(R.layout.activity_lost_found_pet_details);
        pref = getApplicationContext().getSharedPreferences("MyPref", MODE_PRIVATE);
        userID = pref.getString("userid", null);
        progressDialog = new ProgressDialog(LostFoundPetDetails.this);
        ...
        try {
            ...
            try {
                ...
                petObject = (lostFoundPetListModel) bundleObject.getSerializable("lostFoundPetListModel");

            } catch (Exception e) {
                e.printStackTrace();
            }

            petId = petObject.getLost_found_id();
...
*/
            ...
            animalPicAdaptor = new AnimalPicAdaptor(LostFoundPetDetails.this, images);

            LinearLayoutManager horizontalLayoutManagaer = new LinearLayoutManager(LostFoundPetDetails.this, LinearLayoutManager.HORIZONTAL, false);
                ...
                public void onTabChanged(String tabId) {
                    if (tabId.equals("Tab Three")) {
                        ...
                        if (userID != null) {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    switch (which) {
                                        case DialogInterface.BUTTON_POSITIVE:
                                            ...
                                            Intent intent = new Intent(LostFoundPetDetails.this, LoginActivity.class);
                                            intent.putExtra("key", "LostFoundPetDetails");
                                            Bundle bundleObject = new Bundle();
                                            bundleObject.putSerializable("lostFoundPetListModel", petObject);
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(LostFoundPetDetails.this);
    ...
    public void setData() {
        ...
        tv_email.setText(petObject.getReporter_email());
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (flag == 1) {
                                android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(LostFoundPetDetails.this);
