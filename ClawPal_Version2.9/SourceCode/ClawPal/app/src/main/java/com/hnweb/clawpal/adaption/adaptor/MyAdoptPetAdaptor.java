 ...
 */
public class MyAdoptPetAdaptor extends ArrayAdapter<AdoptPetModel> {
    ...
    public MyAdoptPetAdaptor(Context context, ArrayList<AdoptPetModel> data) {
    ...
    public View getView(int position, View rowView, ViewGroup parent) {
        ...
        holder.iv_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showAlertDialog(holder.service_info.getPet_adoption_id());
            }
        });
