 ...
 */
public class MyLostFoundPetsFavAdaptor extends ArrayAdapter<lostFoundPetListModel> {
    ...
    public MyLostFoundPetsFavAdaptor(Context context, ArrayList<lostFoundPetListModel> data) {
  ...
  /*      holder.iv_edit.setOnClickListener(new View.OnClickListener() {
        ...
        holder.iv_delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                delete(holder.service_info.getLost_found_id());
            }
        });
