 ...
 */
public class MyPet_list_Adaptor extends ArrayAdapter<All_Pets_List_Model> {
    ...
    public MyPet_list_Adaptor(Context context, ArrayList<All_Pets_List_Model> data) {
    ...
    public View getView(int position, View rowView, ViewGroup parent) {
        ...
        holder.iv_deletePet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showAlertDialog(holder.all_pets_list_model.getPet_sale_buy_id());
